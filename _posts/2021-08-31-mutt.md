...
##### Teaching Mutt to open a file type in an external program

You can teach Mutt to open new types of attachment in external programs instead
of displaying them as raw text. You need a `mime.types` file and a `mailcap`
file.
...
##### Teaching Mutt to render a file type to text
...
##### Rendering a file type to text and opening it in an external program at the same time
