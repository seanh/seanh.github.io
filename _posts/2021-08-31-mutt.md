...
https://mutt.org/doc/manual/#attach-menu
...
The `copiousoutput` seems to be necessary to prevent <samp>File not found</samp> errors from Firefox.
...
`copiousoutput` entry for in the mailcap file:
