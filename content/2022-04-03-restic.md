...
See [Excluding Files](https://restic.readthedocs.io/en/stable/040_backup.html#excluding-files) in restic's docs for documentation of the include file format.
